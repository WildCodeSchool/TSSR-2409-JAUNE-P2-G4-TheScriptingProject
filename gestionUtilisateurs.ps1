...
{
    Write-Host "`n"
    Write-Host "Quelle action voulez-vous effectuer sur les Comptes Utilisateur ?"
    ...
    Write-Host "4. Activation / Désactivation de Compte Utilisateur local"
    Write-Host "9. Menu Précédent"
    ...
    default {
        Write-Host "`n"
        Write-Host "Erreur - Choix introuvable."
        Write-Host "Merci d'entrer un des choix de la liste suivante"
        Write-Host "`n"
        }
    }
}
