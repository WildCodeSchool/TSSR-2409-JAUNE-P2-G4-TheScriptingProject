        ...
        5
            {
                ...
                Write-Host "L'utilisateur $utilisateur a été ajouté au groupe Administrateurs avec succès" -ForegroundColor Green
            }
        6
            {
                ...
                Write-Host "L'utilisateur $utilisateur a été ajouté au groupe $groupe avec succès" -ForegroundColor Green
            }
        7
            {
                ...
                Write-Host "L'utilisateur $utilisateur a été supprimé du groupe $groupe avec succès" -ForegroundColor Green
            }
        8
            {
                # Lancement Arrêt
        ...
        1
            {
                ...
                $Utilisateur = Read-Host "Quel est l'utilisateur concerné ?"
        ...
        3
            {
                ...
                #quser
		Write-Host "Erreur fonction" -ForegroundColor Red
            }
        4
            {
        ...
        10
            {
                ...
                Get-Partition | Select-Object -Property DiskNumber,DriveLetter,Type,Size
            }
        11
            {
        ...
        14
            {
                ...
                $numInterfaces = (Get-NetAdapter | Where-Object { $_.Status -eq "Up" } | Measure-Object -Line).Lines
