...
#   1-Nombre de disque présent sur l'ordinateur
#   2-Détail des partitions présente sur un disque
#   3-Espace disponible  
#   4-Rechercher l'emplacement d'un dossier 
#   5-Liste des lecteurs montés monter sur l'ordinateur
#   6-Retour au menu précédant
